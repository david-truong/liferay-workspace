...
/**
 * Provides the local service interface for CustomData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CustomDataLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CustomDataLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomDataLocalServiceUtil} to access the custom data local service. Add custom service methods to <code>com.liferay.custom.data.service.impl.CustomDataLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
