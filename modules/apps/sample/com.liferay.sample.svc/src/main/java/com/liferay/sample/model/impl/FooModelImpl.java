...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.sample.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.liferay.sample.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.sample.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.liferay.sample.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.sample.service.util.PropsUtil.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.sample.service.util.PropsUtil.get(
				"lock.expiration.time.com.liferay.sample.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.sample.model.Foo");
