...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	@Override
	public int compareTo(com.liferay.sample.model.Foo foo) {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<com.liferay.sample.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.liferay.sample.model.Foo toEscapedModel() {
	...
	@Override
	public com.liferay.sample.model.Foo toUnescapedModel() {
